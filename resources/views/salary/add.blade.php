...
<form class="layui-form" action="">
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <select name="user_id" id="user_id" lay-filter="user_id">
                ...
                <option value="{{$user->id . '|' . $user->addrres}}" >{{$user->name}}</option>
                @endforeach
                </select>  
        </div>
    </div>
    <div class="layui-form-item">
        ...
        <div class="layui-input-block" style="width:50%;">
            <input type="text" class="layui-input" id="salary_date" value="" placeholder="">
        </div>
    </div>
    <div class="layui-form-item">
        <label class="layui-form-label">工资(￥)：</label>
        <div class="layui-input-block" style="width:50%;">
            <input type="text" name="amount" id="amount" autocomplete="off" placeholder="请输入" class="layui-input">
        </div>
    </div>
    <div class="layui-form-item">
        <label class="layui-form-label">汇率</label>
        <div class="layui-input-block" style="width:50%;">
            <input type="text"  value="{{$cny_to_usd_rate}}" name="cny_to_usd_rate" id="cny_to_usd_rate"  autocomplete="off" placeholder="请输入" class="layui-input">
        </div>
    </div>
    <div class="layui-form-item">
        <label class="layui-form-label">工资($)：</label>
        <div class="layui-input-block" style="width:50%;">
            <input type="text" name="usd_salary" id="usd_salary" autocomplete="off" placeholder="请输入" class="layui-input">
        </div>
    </div>
    <div class="layui-form-item">
